...
app.get('/api/count-products', async (req,resp)=>{
    try {
...
//Promedio de valor por categoría (category_code)  
...
//Suma total por tipo de producto (productType)
app.get('/api/sum-value-by-productType', async (req,resp)=>{
    try {
        const data= await Products.findAll({
            attributes: [
                'productType',
